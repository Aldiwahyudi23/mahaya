...
<section class="content card" style="padding: 10px 10px 10px 10px ">
    <div class="box">
        <h4><i class="nav-icon fas fa-user my-1 btn-sm-1"></i> Anggota</h4>
        <hr>
                                                    ...
                                                    <table class="table table-hover table-head-fixed" id='tabelAgendaMasuk'>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>{{$anggota->role}}</td>
                                                                <td>
                                                                    <a href="/tabungan/anggota/{{$anggota->id}}/cetakprint" target="_blank" class="btn btn-primary btn-sm my-1 mr-sm-1"><i class="nav-icon fas fa-print"></i></a>
                                                                </td>
                                                                <td>
                                                                    <a href="/tabungan/anggota/edit/{{$anggota->id}}" class="btn btn-primary btn-sm my-1 mr-sm-1"><i class="nav-icon fas fa-pencil-alt"></i></a>
                                                                </td>
                                                                <td>
                                                                    @if (auth()->user()->role == 'Admin')
                                                                    <a href="/pemasukan/anggota/{{$anggota->id}}/delete" class="btn btn-danger btn-sm my-1 mr-sm-1" onclick="return confirm('Hapus Data ?')"><i class="nav-icon fas fa-trash"></i></a>
                                                                    @endif
                                                                </td>
                                                            </tr>
                                                            @endforeach
