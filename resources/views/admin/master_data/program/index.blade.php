                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="/program/tambah" method="POST" enctype="multipart/form-data">
                                    {{csrf_field()}}
                                    <div class="form-group row">
                                        <label for="pengurus_id">Ketua</label>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <input value="{{old('nama_program')}}" name="nama_program" type="text" class="form-control bg-light" id="nama_program" required oninvalid="this.setCustomValidity('Isian ini tidak boleh kosong !')" oninput="setCustomValidity('')">
                                    </div>
                               
                                    <div class="form-group row">
                                        <label for="deskripsi">Deskripsi</label>
                                        <textarea name="deskripsi" class="form-control bg-light" id="deskripsi" rows="3" placeholder="Eusian deskripsi ieu sesuai deskripsi program hasil kesepakatan, kedah detail" required oninvalid="this.setCustomValidity('Isian ini tidak boleh kosong !')" oninput="setCustomValidity('')">{{old('keterangan')}}</textarea>
                                    </div>
                                    <hr>
                        ...
                        <div class="card">
                            <div class="card-header bg-light p-2">
                                <ul class="nav nav-pills">
                                    <li class="nav-item"><a class="nav-link active btn-sm" href="#setor" data-toggle="tab"><i></i> Data program</a></li>
